...
Реализована очистка тестовых данных на основе списков созданных todo после выполнения каждого тестового класса. 
